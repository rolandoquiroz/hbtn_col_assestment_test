...
SECRET_KEY = \
    'django-insecure-^#!2!ak1s+^w&rhp=db8o+_*)@w0s19u8q2!-(--*qfn$+b5us'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["192.168.1.82", "127.0.0.1", "localhost"]
...
CORS_ORIGIN_WHITELIST = (
    ...
    'http://192.168.1.82:8080',  # localhost
    'http://192.168.1.55:8080',  # Movil
    'http://192.168.1.58:8080',  # PC
)
